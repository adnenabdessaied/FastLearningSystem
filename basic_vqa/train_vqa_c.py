...
from models import VqaModelDncC
...
def main(cfg):
    ...
    qst_encoder_params = {"params": model.qst_encoder.parameters()}
    ...
    if cfg["hyperparameters"]["optimizer"] == "adam":
        optimizer = optim.Adam(
            [dnc_c_params, qst_encoder_params, img_encoder_params, fc_1_params, fc_2_params],
            ...
            for batch_idx, batch_sample in enumerate(pbar):
                ...
                with torch.set_grad_enabled(phase == "train"):
                    ...
                    if phase == 'train':
                        ...
                        lr_dnc_c = optimizer.param_groups[0]["lr"]
                        lr = optimizer.param_groups[1]["lr"]
                        dict_lr = {"DNC_C": lr_dnc_c,
                                   "Rest": lr}
