...
Code based on
-->
https://github.com/tbmoon/basic_vqa/tree/master/utils
<--
"""
...
def vqa_processing(image_dir, annotation_file, question_file, valid_answer_set, image_set):
    ...
    abs_image_dir = os.path.join(image_dir, coco_set_name)
...
def main(args):
    ...
    # test_dev = vqa_processing(image_dir, annotation_file, question_file, valid_answer_set, 'test2015')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='/data/VQA/text',
                        help='directory for inputs')
    parser.add_argument('--image_dir', type=str, default='/data/VQA/images',
                        help='directory for inputs')

    parser.add_argument('--output_dir', type=str, default='/data/BASIC_VQA',
